                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select type="string" placeholder="Select user role" id="role_id" class="form-control @error('role_id') is-invalid @enderror" name="role_id" value="{{ $user->role_id }}" required autocomplete="role_id" autofocus>
                                <option selected disabled>Select user type</option>
                                <option value="1" {{($user->role_id === 1) ? 'Selected' : ''}}>Admin</option>
                                <option value="2" {{($user->role_id === 2) ? 'Selected' : ''}}>Patient</option>
                                <option value="3" {{($user->role_id === 3) ? 'Selected' : ''}}>Doctor</option>
                            </select>
