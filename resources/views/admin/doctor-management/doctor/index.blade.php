...
<script>
    ...
    $(function () {
        var table = $('#users').DataTable({
            ...
            "serverSide": true,
            "ajax": {
                url: "{{ config('app.url') }}/admin/doctor/get/all",
                type: "GET",
                cache: false,
                error: function () {
            ...
            fnRowCallback: function (nRow, aData, iDisplayIndex, iDisplayIndexFull) {
                ...
                var actions = '<a href="{{ config("app.url") }}/admin/doctor/add/extra_data/'+aData['id']+'" class="btn btn-xs btn-warning mr-2"><i class="fa fa-plus-square"></i></a>';
