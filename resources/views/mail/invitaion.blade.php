                    ...
                    <tr>
                        <td valign="top" class="em_aside">
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                ...
                                <tr>
                                    <td align="center" style="font-family:'Open Sans', Arial, sans-serif; font-size:18px; font-weight:bold; line-height:20px; color:#feae39;">Your Appointment {{$link->appointmentNumber}} at {{$link->scheduledTime}} on {{$link->appointmentDate}} was cancelled. Sorry for the inconvenience.</td>
                                </tr>
                                <tr>
